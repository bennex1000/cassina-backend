 ...
 */
export const calculateCooldownDuration = (speedValue) => {
 ...
 */
export const lockCooldown = async (userId, speedValue) => {
    try {
 ...
 */
export const unlockCooldown = async (userId) => {
    try {
        await db.query(`
      UPDATE user_progression
      SET 
 ...
 */
export const getCooldownStatus = async (userId) => {
    try {
