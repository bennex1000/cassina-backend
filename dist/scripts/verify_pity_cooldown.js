...
async function runVerification() {
    ...
    try {
        ...
        await db.query("INSERT INTO users (user_id, username, email, password_hash, level, experience) VALUES ($1, 'pity_tester', $2, 'hash', 1, 0)", [TEST_USER_ID, TEST_EMAIL]);
        // Initialize progression
        await db.query("INSERT INTO user_progression (user_id, current_wheel_tier_id) VALUES ($1, 1)", [TEST_USER_ID]);
        // --- TEST PITY SYSTEM ---
        ...
        if (!statusBefore.ok)
            throw new Error(String(statusBefore.error));
...
runVerification();
//# sourceMappingURL=verify_pity_cooldown.js.map